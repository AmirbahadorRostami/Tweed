...
public class GameManager : MonoBehaviour
{
    ...
    public void ShowTutorial()
    {
        ...
        if (level == 2)
        {
            if (!tutorials.GetComponent<Tutorials>().tutorialSkipped)
            {
    ...
    public void HideUI()
    {
        ...
        UI_MoveStick.transform.GetChild(0).GetComponent<RectTransform>().anchoredPosition = new Vector3(0, 0, 0);
    ...
    public void QuitGame()
    {
        ...
        switch (userData.prize)
        {
            case ("sativa_kit"):
                openWindow("https://tweedfieldtrip.com/prizing-information-collection/?pid=spk");
                break;
            case ("indica_kit"):
                openWindow("https://tweedfieldtrip.com/prizing-information-collection/?pid=ipk");
                break;
            case ("hybrid_kit"):
                openWindow("https://tweedfieldtrip.com/prizing-information-collection/?pid=hpk");
                break;
            case ("uber_code"):
                openWindow("https://tweedfieldtrip.com/prizing-information-collection/?pid=uc");
                break;
        }
